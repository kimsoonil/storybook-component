...
export const VERIFY_SEND_SOURCE_SMS = 1;
export const VERIFY_SEND_SOURCE_EMAIL = 2;
export const VERIFY_SEND_TYPE_SIGNUP = 1;
export const VERIFY_SEND_TYPE_CHANGE = 4;
export const VERIFY_SEND_TYPE_LEAVE = 5;

// LogIn
export const LOGIN_FAIL_COUNT = 5;
export const SNS_GOOGLE = 'google';
export const SNS_APPLE = 'apple';
export const SNS_FACEBOOK = 'facebook';
export const SNS_TWITTER = 'twitter';
export const SNS_CCR = 'ccr';
...
export const POPUP_TYPE_BADGE = 'Badge';
export const POPUP_TYPE_NICKNAME_CONFIRM = 'Nickname';
...
export const IMAGE_TYPE_BANNER = 'banner_image';
export const IMAGE_TYPE_THUMBNAIL = 'thumbnail_image';
export const FORUM_NAME_MAXLENGTH = 30;
export const FORUM_DISC_MAXLENGTH = 200;
export const BANNER_IMAGE_WIDTH = 1280;
export const BANNER_IMAGE_HEIGHT = 268;
export const THUMBNAIL_IMAGE_WIDTH = 200;
export const THUMBNAIL_IMAGE_HEIGHT = 200;
