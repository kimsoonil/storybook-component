    ...
    <div className="posts-container-comment ">
      ...
      <div className="relative">
        <div className="flex-center posts-container-comment-profile">
          <img
            src={
              clubId?.data?.profile?.profile_image_url
                ? clubId.data.profile.profile_image_url
                ...
                <div className="comment-list-item">
                  <div className="flex-between">
                    <div className="comment-list-item-icon">
                      ...
                      {commentItem.profile?.staff_title === null ? (
                        <>
                          <div className="profile-rating flex-center">{commentItem.profile?.grade_title}</div>
                          <div className="profile-level">LV {commentItem.profile?.level}</div>
                        </>
                      ) : (
                        <div className="profile-staff flex-center">{commentItem.profile?.staff_title}</div>
                      )}
                    </div>
                    <div>
