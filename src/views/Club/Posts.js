...
function Posts(props) {
  ...
  useEffect(() => {
    if (post?.data) {
      ...
      localStorage.setItem('board', post?.data?.board_name);
      localStorage.setItem('boardGroup', post?.data?.board_group_name);
    }
  }, [post]);
            ...
            <div className="flex-between posts-container-header">
              <div>
                <div className="posts-container-nav" onClick={() => navigate(`/club/${id}/board/${post.data.board}`)}>
                  {post.data.board_group_name} &gt; {post.data.board_name}
                </div>
                ...
                <div className="posts-container-profile">
                  ...
                  <div className="posts-container-profile-info">
                    <div className="posts-container-profile-info-tag">
                      ...
                      {post.data?.profile?.staff_name === null ? (
                        <>
                          <div className="profile-rating flex-center">{post.data?.profile?.grade_name}</div>
                          <div className="profile-level">LV {post.data?.profile?.level}</div>
                        </>
                      ) : (
                        <div className="profile-staff flex-center">{post.data?.profile?.staff_name}</div>
                      )}
                    </div>
                    <div>
