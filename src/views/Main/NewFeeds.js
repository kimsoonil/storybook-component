        ...
        <div className="item">
          ...
          <div className="home-box newfeeds-body">
            {[...Array(6)].map((item,index) => {
              return(<div className="newfeeds-list flex-between" key={index}>
              <div>
              <div className="newfeeds-list-title">게시글 제목입니다.
              </div>
              <div className="newfeeds-list-content">Lorem ipsum dolor sit amet, consectetur  elit, sed do eiusmod tempor
