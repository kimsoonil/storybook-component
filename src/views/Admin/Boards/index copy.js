...
import BoardInfo from './Info/BoardInfo';
import BoardGroupInfo from './Info/BoardGroupInfo';
...
const Boards = () => {
  ...
  // const [selected, setSelected] = useState({id: -1, type: -1})
    ...
    <div className="boards">
      ...
      <div className="boards-contents-wrapper">
        ...
        {selected.id < 0 ? (
          ...
          <BoardGroupInfo clubId={clubId} />
        ) : (
          <BoardInfo clubId={clubId} />
        )}
      </div>
    </div>
  );
