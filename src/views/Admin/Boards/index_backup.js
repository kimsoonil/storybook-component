...
// import 'assets/scss/admin/boards-copy.scss';
...
//         ret = 'default';
//       }
//     } else if (type === 'ALL' || type === 'NOTICE' || type === 'EVENT') {
//       ret = 'default';
...
//       }
//     } else {
//       dispatch(openDeleteGroupDialog({ id: boardGroup.id, clubId }));
//     }
//   };
...
//       dispatch(openMergeGroupDialog({ id: boardGroup.id, boardGroups: _boardGroups, clubId }));
//     } else {
...
//     if (_boards.length > 0) {
//       dispatch(openMergeBoardDialog({ id: board.id, boards: _boards, clubId }));
//     } else {
...
//         }
//       } else {
//         dispatch(openDeleteBoardDialog({ id: board.id, clubId }));
//       }
//     }
...
//       const { order } = boardGroups[destination.index];
...
//                                                   }
//                                                 >
//                                                   <div className={`bd-name-text bd-name-text-${activeBoardClassName}`}>
//                                                     {_board.name}
//                                                   </div>
//                                                   {boardType !== 'default' && (
//                                                     <MoreOptionButton
...
// function NameSidebarInput({ value, onChange, rename = () => {}, placeholder }) {
//   return (
//     <input
