...
import clubSaga from 'redux/clubSaga';
...
const Boards = () => {
  ...
  const boardGroupsLoading = useSelector((state) => state.club.boardGroups?.isLoading);

  const boardGroup = useSelector((state) => state.boardGroup.boardGroup?.data);
  const boardGroupLoading = useSelector((state) => state.boardGroup?.isLoading);

  const board = useSelector((state) => state.board.board?.data);
  const boardLoading = useSelector((state) => state.board?.isLoading);
  ...
  const newBoardGroups = useSelector((state) => state.boardAdmin.boardGroups);
