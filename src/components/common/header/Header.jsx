          ...
          {isLogin && (
            <ul className="persnal_menu">
              ...
              <li>
                <button
                  type="button"
                  className="gnb chat open_tip"
                  onClick={() => {
                    const width = 1280;
                    const height = 720;
                    const options = `width=${width}, height=${height}, status=no, menubar=no, toolbar=no, resizable=no, fullscreen=yes, scrollbars=no`;
                    window.open('/chat', 'name(chat)', options);
                  }}
                >
              ...
              {isLogin && (
                ...
                <div className="mini_profile_con">
                  ...
                  <ProfileLayer isShow={isViewProfile} setIsShow={setIsViewProfile} />
                </li>
              )}
            </ul>
          )}
